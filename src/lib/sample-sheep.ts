...
function fluffySheep(): { body: Stroke[]; hindLegs: Stroke[]; frontLegs: Stroke[] } {
  ...
  const hindLegs: Stroke[] = [
    { points: linePath(105, 155, 100, 200), color: '#ffffff', size: 3 },
    { points: linePath(125, 155, 120, 200), color: '#ffffff', size: 3 },
  ]

  const frontLegs: Stroke[] = [
    { points: linePath(175, 155, 180, 200), color: '#ffffff', size: 3 },
    { points: linePath(195, 155, 200, 200), color: '#ffffff', size: 3 },
  ]
...
function skinnySheep(): { body: Stroke[]; hindLegs: Stroke[]; frontLegs: Stroke[] } {
  ...
  const hindLegs: Stroke[] = [
    { points: linePath(115, 145, 112, 205), color: '#ffffff', size: 2 },
    { points: linePath(130, 145, 127, 205), color: '#ffffff', size: 2 },
  ]

  const frontLegs: Stroke[] = [
    { points: linePath(175, 145, 178, 205), color: '#ffffff', size: 2 },
    { points: linePath(188, 145, 191, 205), color: '#ffffff', size: 2 },
  ]
...
function babySheep(): { body: Stroke[]; hindLegs: Stroke[]; frontLegs: Stroke[] } {
  ...
  const hindLegs: Stroke[] = [
    { points: linePath(122, 162, 120, 200), color: '#ffffff', size: 3 },
    { points: linePath(138, 162, 136, 200), color: '#ffffff', size: 3 },
  ]

  const frontLegs: Stroke[] = [
    { points: linePath(162, 162, 165, 200), color: '#ffffff', size: 3 },
    { points: linePath(178, 162, 181, 200), color: '#ffffff', size: 3 },
  ]
